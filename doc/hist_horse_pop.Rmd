...
This project explores the historical population of horses in Canada @weinstock2005evolution between 1906 and 1972 for each Province.
...
```{r plot horses, fig.width=11, fig.height=3, fig.cap="Fig 01. Distribution of horses", out.width="100%"}
...
max_horses <- horse_pop %>% 
  ...
  summarize(Maximum = max(Value),
            Minimum = min(Value))
knitr::kable(max_horses, caption = "Table 01. Range of number of horses in each province")
```

Below we zoom in and look at the province of `r province`:

```{r plot province, fig.width=5, fig.height=4, fig.cap="Fig 02.Number of horses per province", out.width='100%'}
